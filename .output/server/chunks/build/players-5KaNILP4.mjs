import { _ as _sfc_main$1 } from './LeadboardWidget-CJWBGgmu.mjs';
import { _ as __nuxt_component_0 } from './nuxt-link-V08wtwK9.mjs';
import { _ as _sfc_main$2 } from './LeadboardItem-CQiDYyoU.mjs';
import { _ as _sfc_main$3 } from './BottomMenu-DK9IKwv9.mjs';
import { _ as _sfc_main$4 } from './MainButton-wKHtjEam.mjs';
import { withCtx, createVNode, Transition, useSSRContext } from 'vue';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_BottomMenu = _sfc_main$3;
      const _component_MainButton = _sfc_main$4;
      _push(`<!--[--><template><div class="flex flex-col gap-y-6"><h2 class="text-2xl font-bold uppercase text-center">Top players</h2>`);
      ...
      _push(`<div class="flex flex-col gap-y-2"><h4 class="px-4 text-lg font-bold uppercase">All players:</h4><!--[-->`);
      ssrRenderList(3, (el) => {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/players.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=players-5KaNILP4.mjs.map
