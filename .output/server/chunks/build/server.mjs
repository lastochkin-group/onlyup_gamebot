...
const _routes = [
  ...
  },
  {
    ...
    path: "/onboarding",
    component: () => import('./onboarding-3ATNqEc-.mjs')
  },
  {
    name: "players___en",
    path: "/players",
  ...
  },
  {
    name: "store___en",
    path: "/store",
    component: () => import('./store-C3nnaZ1d.mjs')
  },
  {
    name: "team-id___en",
    path: "/team/:id()",
    component: () => import('./_id_-DHOKfd5q.mjs')
  },
  {
    name: "teams___en",
    path: "/teams",
...
const localeLoaders = {
  "en": [{ key: "../lang/en-US.json", load: () => import(
    './en-US-BgUC87bo.mjs'
    /* webpackChunkName: "locale__Users_lastochkin_My_32projects_OnlyUpGamebot_lang_en_US_json" */
  ), cache: true }]
};
...
const normalizedLocales = [
  {
    ...
    "files": [
      {
        "path": "/Users/lastochkin/My projects/OnlyUpGamebot/lang/en-US.json"
      }
    ]
  }
];
...
const telegram_NrpopEC7aI = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
});
const plugins = [
  unhead_KgADcZ0jPj,
  plugin,
